...
class Test_User_Profile:
    ...
    #             "C:\\Users\\girish kadam\\PycharmProjects\\Revision Project\\Credkart\\Pytest_Credkart\\Screenshots\\Registration_Pass.png")
    #         # self.driver.close()
    #         assert True
    #     else:
    #         self.log.info("test_UserRegistration_001 is fail")
    #         self.driver.save_screenshot(
    #             "C:\\Users\\girish kadam\\PycharmProjects\\Revision Project\\Credkart\\Pytest_Credkart\\Screenshots\\Registration_Fail.png")
    #         # self.driver.close()
    #         assert False
    ...
    def test_UserLogin_002(self, setup):
        ...
        if self.ur.Validate_Login_Or_Registration() == "Login or Registration Pass":
            self.driver.save_screenshot(
                "C:\\Users\\girish kadam\\PycharmProjects\\Revision Project\\Credkart\\Pytest_Credkart\\Screenshots\\Login_Pass.png")

            # self.driver.close()
            assert True
        else:
            self.driver.save_screenshot(
                "C:\\Users\\girish kadam\\PycharmProjects\\Revision Project\\Credkart\\Pytest_Credkart\\Screenshots\\Login_Fail.png")
...
# pytest -v --html=HTMLReports/Edge_Report.html --browser chrome -n=5 --alluredir="C:\Users\girish kadam\PycharmProjects\Revision Project\Credkart\Pytest_Credkart\AllureReports"
